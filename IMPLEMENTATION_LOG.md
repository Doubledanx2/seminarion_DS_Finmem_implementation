...
| Q1 | 2026-06-12 | **Open question for Dan:** ARCHITECTURE.md §2 says FinBERT "(ProsusAI/finbert)" but the authors' code uses `yiyanghkust/finbert-tone`. Recommendation: stay with finbert-tone (repo-faithful) now that labels are corrected. Either works with the name-based mapping |
